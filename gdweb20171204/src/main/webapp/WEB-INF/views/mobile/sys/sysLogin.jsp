	...
	<div data-role="page">
		...
		<div role="main" class="ui-content">
			...
			<form id="loginForm"  action="${ctx}/login" method="post" data-ajax="false">
				...
				<div data-role="fieldcontain">
					<label for="password">密　码：</label> <input type="password" name="password" id="password" value="" class="required" autocomplete="off"/>
				</div>
		...
		<div data-role="footer"  data-theme="b">
			<h4>Copyright 2013 The ezSite Foundation</h4>
		</div><!-- /footer -->
	</div><!-- /page -->
	</body>
</html>