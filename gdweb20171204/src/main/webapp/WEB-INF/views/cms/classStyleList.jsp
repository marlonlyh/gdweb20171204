...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="cms:article:edit"><li><a href="<c:url value='${fns:getAdminPath()}/cms/article/form?id=${article.id}&category.id=${article.category.id}'></c:url>">${article.category.name}添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr>
				...
				<th>栏目</th><th>标题</th><th>权重</th><th>年级</th><th>班级</th><th>专业</th><th>点击数</th><th>发布者</th><th>更新时间</th><th>操作</th></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="article">
			<tr>
				...
				<td>${article.grade.gradeName}</td>
				<td>${article.classes.className}</td>
				<td>${article.major.majorName}</td>
				<td>${article.hits}</td>
