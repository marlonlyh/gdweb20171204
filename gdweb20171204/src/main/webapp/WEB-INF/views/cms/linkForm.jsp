...
<body>
	...
	<form:form id="inputForm" modelAttribute="link" action="${ctx}/cms/link/save" method="post" class="form-horizontal">
		...
		<c:if test="${link.category.id ne fns:getDictValue('front.exhibition.bottom','comm_category_id','3053')}">
			<div class="control-group">
				<label class="control-label">链接地址:</label>
				<div class="controls">
					<form:input path="href" htmlEscape="false" maxlength="1000" class="input-xxlarge"/>
				</div>
			</div>
		</c:if>
