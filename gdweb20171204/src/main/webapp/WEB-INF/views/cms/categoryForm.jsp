...
<body>
	...
	<form:form id="inputForm" modelAttribute="category" action="${ctx}/cms/category/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">栏目简称:</label>
			<div class="controls">
				<form:input path="shortEn" htmlEscape="false" maxlength="50"/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden path="image" htmlEscape="false" maxlength="1000" class="input-xlarge"/>
				<tags:ckfinder input="image" type="images" uploadPath="/cms/category"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">栏目广告图片:</label>
			<div class="controls">
				<form:hidden path="banner" htmlEscape="false" maxlength="1000" class="input-xlarge"/>
				<tags:ckfinder input="banner" type="images" uploadPath="/cms/category"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">在app导航中显示:</label>
			<div class="controls">
				<form:radiobuttons path="appinMenu" items="${fns:getDictList('show_hide')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
				<span class="help-inline">是否在app导航中显示该栏目</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" title="app展示列表">app展示列表:</label>
			<div class="controls">
				<form:radiobuttons path="showflag" items="${fns:getDictList('cms_showflag')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" title="app展示内容">app展示内容:</label>
			<div class="controls">
				<form:radiobuttons path="showcontent" items="${fns:getDictList('cms_showcontent')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
			</div>
		</div>
		<!-- 
		<div class="control-group">
