...
<meta name="author" content="http://www.yilan5.com"/><meta http-equiv="X-UA-Compatible" content="IE=7,IE=9,IE=10" />
...
<link href="${ctxStatic}/common/ezsite.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/ezsite.min.js" type="text/javascript"></script>
