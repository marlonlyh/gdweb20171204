...
<head>
	...
	<script type="text/javascript">
		...
		function changeTheme(dict){
			var locations = window.location.href;
			window.location = ${pageContext.request.contextPath}"/theme/"+dict+"?url="+locations;
		}
...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <%-- <a class="brand" href="${ctx}"><img src="${ctxStatic}/front/images/logo.jpg" alt="南粤武警学习后台管理系统" style="height:40px;"></a> --%>
        </div>
      </div>
    </div>
    ...
    <div class="container">
		...
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.whir.ht.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
        <div id="login-wraper">
            <form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
                ...
                <div class="body">
					...
					<div class="control-group">
						<div class="controls">
							<input type="text" id="password1"  class="required" placeholder="密码" autocomplete="off" onkeypress="javascript:hiddenPass(event)" onkeyup="this.value=this.value.replace(/./g,'*');"/>
