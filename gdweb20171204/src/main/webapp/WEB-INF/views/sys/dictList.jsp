...
<body>
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="breadcrumb form-search">
		...
		<label>类型：</label><form:select id="type" path="type" class="input-small" style="width:170px;"><form:option value="" label=""/><form:options items="${typeList}" htmlEscape="false"/></form:select>
