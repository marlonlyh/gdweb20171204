...
import com.whir.ht.common.utils.FileUtils;
import com.whir.ht.common.utils.FreeMarkers;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/whir/ht/generate/template", "/", separator);
