...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	/** 随机背景图片路径 */
	private static final String BACKGROUND_IMAGE_PATH = "/com/whir/ht/cms/captcha/";
	 ...
	 * 随机颜色
	 */
	private static final Color[] COLORS = new Color[] { new Color(255, 255, 255),new Color(255, 220, 220),new Color(220, 255, 255),new Color(255, 255, 220),new Color(220, 255, 220)};
