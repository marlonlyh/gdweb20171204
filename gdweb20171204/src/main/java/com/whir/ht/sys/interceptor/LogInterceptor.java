 ...
 */
package com.whir.ht.sys.interceptor;
...
import com.whir.ht.sys.dao.LogDao;
...
//			if(viewName.startsWith("gdweb/") && DeviceType.MOBILE.equals(userAgent.getOperatingSystem().getDeviceType())){
//				modelAndView.setViewName(viewName.replaceFirst("gdweb", "mobile"));
//			}
		}
